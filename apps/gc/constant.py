...
RAW_AUTH_URL = f"""https://accounts.google.com/o/oauth2/v2/auth/oauthchooseaccount?redirect_uri={REDIRECT_URL}&prompt=consent&response_type=code&client_id={config('CLIENT_ID')}&scope={SCOPES}&access_type=offline&service=lso&o2v=2&flowName=GeneralOAuthFlow"""
